...
const ChartOne: React.FC = () => {
	...
	return (
		<div className="col-span-12 rounded-xs border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
				...
				<div className="flex w-full flex-wrap gap-3 sm:gap-5">
					<div className="flex min-w-47.5">
						...
						<div className="w-full">
							<p className="font-semibold text-primary">Total Scheduled</p>
					...
					<div className="flex min-w-47.5">
						...
						<div className="w-full">
							<p className="font-semibold text-secondary">Total Finished</p>
							<p className="text-sm font-medium">12.04.2024 - 12.05.2024</p>
						</div>
					</div>
				</div>
