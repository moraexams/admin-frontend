...
export default function StreamWiseStats() {
	...
	return (
		<section className="mt-8 mb-5">
			<h2 className="text-xl font-semibold mb-2">Total Stream Wise Stats</h2>
				...
				<tbody>
					<>
						{streamStats.counts?.map((count: any, key: number) => (
							<tr key={key}>
								<td className="py-5">
									<h5 className="font-medium">{count.stream_name}</h5>
								</td>
								<td className="py-5">
									<p>{count.tamil_count}</p>
								</td>
								<td className="py-5">
									<p>{count.english_count}</p>
								</td>
								<td className="py-5">
									<p className="font-semibold">{count.total_count}</p>
								</td>
							</tr>
						))}
						<tr className="font-semibold">
							...
							<td className="py-5">
								<p>{streamStats.total_tamil}</p>
							</td>
							<td className="py-5">
								<p>{streamStats.total_english}</p>
							</td>
							<td className="py-5">
