import { deleteTransactionCategory } from "../services/financeServices";
...
export default function Table(props: Props) {
	  ...
	  const handleDelete = (categoryId: string) => {
		try{
			deleteTransactionCategory(categoryId).then(() => {
				toast.success("Transaction category deleted successfully.");
          ...
          <tr key={row.toString()}>
            ...
            <td className="border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark">
              <div className="flex justify-center">
                <button type="button" className="hover:text-primary" onClick={() => handleDelete(row[0].toString())}>
					 <svg
