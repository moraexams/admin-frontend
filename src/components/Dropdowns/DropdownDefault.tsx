	...
	return (
		<div className="relative flex">
			...
			<div
				...
				className={`absolute right-0 top-full z-40 w-40 space-y-1 rounded-xs border border-stroke bg-white p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark ${
					dropdownOpen === true ? "block" : "hidden"
				}`}
			>
				<button
					type="button"
					className="flex w-full items-center gap-2 rounded-xs px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4"
				>
					<svg
						className="fill-current"
						width="16"
