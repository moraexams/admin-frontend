...
const StudentTable = ({
	...
	const examDistrictChange = (district_id: number) => {
		...
		const currentCenters = centers.filter(
			(center) => center.district_id === district_id,
		);
							...
							<div className="flex justify-around pb-8">
								<div className="flex items-center rounded-lg">
									<button
										...
										className={`inline-flex items-center gap-2.5 rounded-l-lg border border-primary text-primary px-2 py-1 font-medium hover:border-primary hover:bg-primary hover:text-white dark:hover:border-primary sm:px-6 sm:py-3 ${
