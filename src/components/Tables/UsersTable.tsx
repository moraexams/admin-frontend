...
const UsersTable = ({ userData, itemsPerPage }: { userData: User[], itemsPerPage: number }) => {
                  ...
                  <tr key={key}>
                      ...
                      <p className="text-black dark:text-white">
                        ...
                        {user.role === "admin" ? (
                          <svg
                            ...
                            className="inline-block text-yellow-300 icon icon-tabler icons-tabler-outline icon-tabler-crown"
                          >
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <div className="flex items-center space-x-3.5">
                        {!user.approved && (<button onClick={() => { if (user.id) callApproveUser(user.id) }} className="hover:text-primary">
