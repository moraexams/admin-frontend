...
import { District, Stream, StudentMark } from '../../types/types';
    ...
    return (
        <DefaultLayout>
            ...
            <div className="flex flex-wrap gap-x-4">
                ...
                <div className="mb-5.5">
                    ...
                    >
                        ...
                        {
                            streams.map((stream) => { return (<option key={stream.id} value={stream.id}>{stream.name.substring(0,3)}</option>) })
                        }
                    </select>
                </div>
            ...
            <div className="flex flex-col gap-10">
                {loading ? <div>Loading...</div> : <StudentMarksTable studentData={students} nameSearchKey={searchKey} itemsPerPage={itemsPerPage} />}
            </div>
        </DefaultLayout>
    );
}
