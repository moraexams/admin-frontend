  ...
  return (
    <main className="mx-auto h-screen grid grid-cols-1 grid-rows-[auto_auto] gap-y-8 lg:grid-cols-[1fr_1fr] lg:grid-rows-1 items-center max-w-[min(80vw,1400px)]">
      <div className="text-center">
        ...
        <p className="text-center mx-auto max-w-[28ch]">Dashboard for managing students and marks for Mora Exams.</p>
      </div>

      <div className="w-full max-w-[500px] mx-auto">
        <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">Sign Up to Mora Exams</h2>
        ...
        <form>
          ...
          <div className="mb-6">
            <label htmlFor="retype-password" className="mb-2.5 block font-medium text-black dark:text-white">
              Re-type Password
            </label>
            <div className="relative">
              <input
